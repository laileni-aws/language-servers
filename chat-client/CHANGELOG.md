...
## [0.1.11](https://github.com/laileni-aws/language-servers/compare/chat-client/v0.1.10...chat-client/v0.1.11) (2025-05-22)
...
* add context transparency feature ([#903](https://github.com/laileni-aws/language-servers/issues/903)) ([9432ffb](https://github.com/laileni-aws/language-servers/commit/9432ffb8586e4f8181c4f14944b0d3d32aff3e78))
...
* add header and buttons to chat response ([#1020](https://github.com/laileni-aws/language-servers/issues/1020)) ([ada6c7f](https://github.com/laileni-aws/language-servers/commit/ada6c7fd36dc9f64f093d7629e957d23e322848d))
* add pair programming card ([#1023](https://github.com/laileni-aws/language-servers/issues/1023)) ([59cf153](https://github.com/laileni-aws/language-servers/commit/59cf15385c320e6644b04548e1eb61a68ca784de))
...
* **chat-client:** add feature flag to toggle agentic mode ([#1172](https://github.com/laileni-aws/language-servers/issues/1172)) ([8d3d5eb](https://github.com/laileni-aws/language-servers/commit/8d3d5eb49638f858ddf3f99e443bda8f63680872))
* **chat-client:** added support for redirecting message handling to custom adapter ([#905](https://github.com/laileni-aws/language-servers/issues/905)) ([b95fe1e](https://github.com/laileni-aws/language-servers/commit/b95fe1e1a63f6df469bcd0c5e58a66c0819feb55))
* **chat-client:** handle chat updates for existing messages ([#1048](https://github.com/laileni-aws/language-servers/issues/1048)) ([74abb12](https://github.com/laileni-aws/language-servers/commit/74abb126a736e3c37beb492bc7405b02c953296c))
* **chat-client:** history list and conversation actions ([#929](https://github.com/laileni-aws/language-servers/issues/929)) ([5b8e83c](https://github.com/laileni-aws/language-servers/commit/5b8e83cacc56d854623a6e2b59f2f920538f5b85))
...
* **chat-client:** open use input prompt for agentic chat and new prompt should st… ([#1081](https://github.com/laileni-aws/language-servers/issues/1081)) ([ca1a01d](https://github.com/laileni-aws/language-servers/commit/ca1a01dd0487e13f91c36f5288dc1b3b0232c682))
* **chat-client:** support profile banner changes ([#988](https://github.com/laileni-aws/language-servers/issues/988)) ([e4d4ef0](https://github.com/laileni-aws/language-servers/commit/e4d4ef026c8a60cc1ddf08c981340a902d628016))
* configure history button based on history enabled/disabled ([#957](https://github.com/laileni-aws/language-servers/issues/957)) ([eded88f](https://github.com/laileni-aws/language-servers/commit/eded88fae2311c2a73d377a479933f9f66df137d))
...
* handle fileClick events ([#919](https://github.com/laileni-aws/language-servers/issues/919)) ([511be2e](https://github.com/laileni-aws/language-servers/commit/511be2e2e6f527039a99f53cb76fbfc180ef9b55))
...
* implement restore tab ([#933](https://github.com/laileni-aws/language-servers/issues/933)) ([ad2c5d7](https://github.com/laileni-aws/language-servers/commit/ad2c5d77e497e9f8a2019eb547b164f5c5992160))
...
* open use input prompt for agentic chat and new prompt should stop current response ([ca1a01d](https://github.com/laileni-aws/language-servers/commit/ca1a01dd0487e13f91c36f5288dc1b3b0232c682))
...
* support create prompt form in chat-client ([#910](https://github.com/laileni-aws/language-servers/issues/910)) ([a1f0310](https://github.com/laileni-aws/language-servers/commit/a1f0310eff33700cff9551c7d3c84356e4246856))
...
* add visibleName property to fix empty directory name when the directory ends with a slash ([#1302](https://github.com/laileni-aws/language-servers/issues/1302)) ([f6d573c](https://github.com/laileni-aws/language-servers/commit/f6d573cc8e6b23cfdcfd9baa5a5c8e705579b23c))
...
* **amazonq:** bundle dependencies ([4a128e7](https://github.com/laileni-aws/language-servers/commit/4a128e78b275d13af13e9c9f059da01b892fb017))
* **amazonq:** hide stop generating button in hybrid chat ([#1006](https://github.com/laileni-aws/language-servers/issues/1006)) ([c2b7c25](https://github.com/laileni-aws/language-servers/commit/c2b7c2549ead850a7c568a64830b2f151bee005a))
* **amazonq:** include mynah ui ([b1dae1b](https://github.com/laileni-aws/language-servers/commit/b1dae1b85e58dcedc7f102d2643f345c6cade135))
...
* **amazonq:** reference local path ([a43366d](https://github.com/laileni-aws/language-servers/commit/a43366d62df5bf9c173f633c08b666d9492ea19d))
* change PP icon ([#1154](https://github.com/laileni-aws/language-servers/issues/1154)) ([e31fcef](https://github.com/laileni-aws/language-servers/commit/e31fcef7e103be2132710d229c16327c5e996162))
...
* **chat-client:** do not route onTabBarButtonClick to custom handler ([08a5a5b](https://github.com/laileni-aws/language-servers/commit/08a5a5b76432aa370ef2ae3fc2ac70f922458c36))
...
* **chat-client:** missing break in getSerializedChat request handling ([#978](https://github.com/laileni-aws/language-servers/issues/978)) ([5555d09](https://github.com/laileni-aws/language-servers/commit/5555d09f2c024621ae706e01a8cac70f5582a7d8))
* **chat-client:** string change ([#1118](https://github.com/laileni-aws/language-servers/issues/1118)) ([f21700a](https://github.com/laileni-aws/language-servers/commit/f21700a6b8573838a3e28e4e087f6864550fa9f2))
* **chat-client:** upgrade to mynah-ui 4.31.1 ([#1165](https://github.com/laileni-aws/language-servers/issues/1165)) ([aa45998](https://github.com/laileni-aws/language-servers/commit/aa45998c6c63a043788a427ddb5f8859854791ab))
* convert switch to checkbox for PPM mode ([#1099](https://github.com/laileni-aws/language-servers/issues/1099)) ([15c171f](https://github.com/laileni-aws/language-servers/commit/15c171f701587de992c14762d9de9698f6846ee6))
* decrease header size for Pair Programmer ([#1216](https://github.com/laileni-aws/language-servers/issues/1216)) ([7ec43e9](https://github.com/laileni-aws/language-servers/commit/7ec43e9c00bfee443bd81d5bff3aee9ba3350cae))
...
* export for answer-stream card item ([#1019](https://github.com/laileni-aws/language-servers/issues/1019)) ([c367ef3](https://github.com/laileni-aws/language-servers/commit/c367ef3a1374032dace0e6755eaa43a1fae6e3c4))
...
* fix for status duplicates for permission checks ([#1237](https://github.com/laileni-aws/language-servers/issues/1237)) ([a77949a](https://github.com/laileni-aws/language-servers/commit/a77949a482cd352ebc5c7eeebb1468a052a5496d))
...
* fix the build after merge with main ([#1213](https://github.com/laileni-aws/language-servers/issues/1213)) ([6d79bc7](https://github.com/laileni-aws/language-servers/commit/6d79bc7dbbc5aa9168c6d5815efc98ea7ead51e0))
...
* highlight command mistype ([#1060](https://github.com/laileni-aws/language-servers/issues/1060)) ([69742be](https://github.com/laileni-aws/language-servers/commit/69742be4348f04f5c683be4dfaa499a7700e99f5))
* immediate full results not getting rendered e.g /help ([#1193](https://github.com/laileni-aws/language-servers/issues/1193)) ([8169b26](https://github.com/laileni-aws/language-servers/commit/8169b263ab62c5315451b6c8a4d5989375a23fdd))
...
* incorrect props for fsWrite message ([#1043](https://github.com/laileni-aws/language-servers/issues/1043)) ([03deddf](https://github.com/laileni-aws/language-servers/commit/03deddf0f756629e7459a71236e408c0ef3e9727))
...
* open initial tab using mynahUI defaults instead of waiting for ChatOptions ([#1322](https://github.com/laileni-aws/language-servers/issues/1322)) ([87178a5](https://github.com/laileni-aws/language-servers/commit/87178a554f23decb45fbdf26f067d0d9801f91a0))
* override the MynahUi default config ([#1183](https://github.com/laileni-aws/language-servers/issues/1183)) ([55b60dd](https://github.com/laileni-aws/language-servers/commit/55b60ddd4a4b204c6f7c5a256b2de10abeb9844b))
...
* prefix if user reject/stop command, whole card should be dimmed ([#1212](https://github.com/laileni-aws/language-servers/issues/1212)) ([394db61](https://github.com/laileni-aws/language-servers/commit/394db61133e09cfaeff2f7510ab60c571c562130))
* prompt options override ([#1171](https://github.com/laileni-aws/language-servers/issues/1171)) ([70e1e1c](https://github.com/laileni-aws/language-servers/commit/70e1e1c55ad229f13f202f34d621bbd8f8e3475a))
* remove @ mention in placeholder q chat text if agentic mode not available ([#1311](https://github.com/laileni-aws/language-servers/issues/1311)) ([28f84fc](https://github.com/laileni-aws/language-servers/commit/28f84fc82fd5e55ec1cdc61d1bcca6e4e447b12f))
* remove duplicate property ([#928](https://github.com/laileni-aws/language-servers/issues/928)) ([c1aaec0](https://github.com/laileni-aws/language-servers/commit/c1aaec06b70f4ef9d5e2a7ad0d1cc4d5d6955087))
* remove examples from welcome message ([#1040](https://github.com/laileni-aws/language-servers/issues/1040)) ([82138b3](https://github.com/laileni-aws/language-servers/commit/82138b37288ac7dc142b5a9f4ee1e5e70b5ef34a))
...
* remove undefined header from followup authenticate button ([#1085](https://github.com/laileni-aws/language-servers/issues/1085)) ([1502bb9](https://github.com/laileni-aws/language-servers/commit/1502bb922117db8fc9f1cfd74db092be5fbba13b))
* remvoe code block insert-to-cursor in pp mode ([#1092](https://github.com/laileni-aws/language-servers/issues/1092)) ([6d12f3e](https://github.com/laileni-aws/language-servers/commit/6d12f3e4b0c78614786228b63cf6bbf34588ca1c))
* replaced icon for history and added tests ([#951](https://github.com/laileni-aws/language-servers/issues/951)) ([da3b664](https://github.com/laileni-aws/language-servers/commit/da3b66414514740f514d96279b826aebc4e86077))
* Revert stop text align ([#1397](https://github.com/laileni-aws/language-servers/issues/1397)) ([439e859](https://github.com/laileni-aws/language-servers/commit/439e8597b5ce8ad052ab571a1a156044f8862206))
...
* spinner text should now say Thinking... ([#1058](https://github.com/laileni-aws/language-servers/issues/1058)) ([0bd7f38](https://github.com/laileni-aws/language-servers/commit/0bd7f38ddce4ca0919a2573bfca1fe0888677bda))
* stop buttom work expected ([#1307](https://github.com/laileni-aws/language-servers/issues/1307)) ([06c752e](https://github.com/laileni-aws/language-servers/commit/06c752e1dee106be73daa73f336213aad5413e67))
* stop button showing in non-agentic chat ([#1230](https://github.com/laileni-aws/language-servers/issues/1230)) ([5c1b6c2](https://github.com/laileni-aws/language-servers/commit/5c1b6c2ed992befca03120635a23b4aa8cda5ebf))
* stop chat response first when close tab ([#1292](https://github.com/laileni-aws/language-servers/issues/1292)) ([3733b43](https://github.com/laileni-aws/language-servers/commit/3733b433a771ece77ae83f55c8e8e3bd13dcd96b))
* Stop text align ([#1321](https://github.com/laileni-aws/language-servers/issues/1321)) ([0f522a1](https://github.com/laileni-aws/language-servers/commit/0f522a17004174d29955bf70c304ad9ca39df623))
* string changes ([#1225](https://github.com/laileni-aws/language-servers/issues/1225)) ([584450f](https://github.com/laileni-aws/language-servers/commit/584450fba054f4bbcd702ab49a58e45d9abd3d1f))
...
* tool cards have the wrong props ([#1084](https://github.com/laileni-aws/language-servers/issues/1084)) ([697dd18](https://github.com/laileni-aws/language-servers/commit/697dd18a5da3e0f6fec9d094a9b1170e94ed3f3b))
* undo buttom not dimmed the card ([#1276](https://github.com/laileni-aws/language-servers/issues/1276)) ([49bd9c9](https://github.com/laileni-aws/language-servers/commit/49bd9c95d8f9213fe878720a20c13d8f045778ee))
* update placeholder ghost message ([#1093](https://github.com/laileni-aws/language-servers/issues/1093)) ([0d2c76e](https://github.com/laileni-aws/language-servers/commit/0d2c76e8f681671c57d7cc4fe574c855dad19e93))
* update pp mode in tab store ([#1128](https://github.com/laileni-aws/language-servers/issues/1128)) ([7c5e5a8](https://github.com/laileni-aws/language-servers/commit/7c5e5a82437c532a304ec9ab04971f2b9c85f0ad))
...
* updating strings for agentic coding experience ([#1223](https://github.com/laileni-aws/language-servers/issues/1223)) ([8302c5e](https://github.com/laileni-aws/language-servers/commit/8302c5e135921f212f63ada664ab5f88610119fc))
* welcome card shows everytime ([#1332](https://github.com/laileni-aws/language-servers/issues/1332)) ([e030bdd](https://github.com/laileni-aws/language-servers/commit/e030bdd2f0daf61c062f64baa92563b539746e71))
